<?php
   ...
   FROM rooms WHERE (checkin <= '$checkin' AND checkout >='$checkout') OR (checkin >= '$checkin' AND checkin <='$checkout') OR (checkin <= '$checkin' AND checkout >='$checkin') )";
            ...
            public function booknow($checkin, $checkout, $name, $phone,$roomname,$amenities,$food)
            {
                $value='';
   ...
   FROM rooms WHERE checkin < '$checkin' AND checkout >'$checkout'))";
                    ...
                    if(mysqli_num_rows($check) > 0)
                    {
                        ...
                        $sql2="UPDATE rooms  SET checkin='$checkin', checkout='$checkout', name='$name', phone='$phone', book='true',Amenities='$value',food='$food' WHERE room_id=$id";
